...
VISION_MODEL = "llama-3.2-11b-vision-preview"  # Vision-capable on Groq
...
def _clean_llm_response(raw: str) -> str:
    """
    Extract the JSON object from the LLM output by finding the first '{' and the last '}'.
    This handles markdown code fences, intro text, BOMs, and whitespace robustly.
    """
    start = raw.find("{")
    end = raw.rfind("}")
