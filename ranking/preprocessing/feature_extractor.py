...
from preprocessing.product_company_features import get_product_company_score, check_is_services_only
...
def extract_features(candidate: Dict[str, Any], jd_keywords: set = None) -> Dict[str, Any]:
    """
    Extract all features and trap signals for a given candidate.
    
    Args:
        candidate (Dict[str, Any]): The candidate dictionary.
        jd_keywords (set): Custom keywords extracted from the Job Description.
    ...
    is_services_only = check_is_services_only(candidate)
